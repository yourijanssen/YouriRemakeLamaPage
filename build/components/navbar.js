 ...
 */
function createNavbarItem(mainList) {
    for (let i = 0; i < navbarItems().length; i++) {
        let listItem = document.createElement('li');
        let link = document.createElement('a');
        let navbarTab = document.createTextNode(navbarItems()[i]);
 ...
 */
function checkIfLoggedIn(mainList) {
...
function createDropDown(mainList) {
